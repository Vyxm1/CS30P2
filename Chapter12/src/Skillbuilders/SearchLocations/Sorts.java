...
public class Sorts
{
	...
	/**
	 * Sorts an array of objects from low to high pre: none post: objects have been
	...
	/**
	 * Sorts an array of integer from low to high pre: none post: Integers have been
	 * sorted from low to high
	 */
	...
	/**
	 * Sorts items[start..end] pre: start > 0, end > 0 post: items[start..end] is
	 * sorted low to high
	 */
