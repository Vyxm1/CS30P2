	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String[] dieImages = {
						"../Chapter10/src/SkillBuilders/die1.jpeg",
						"../Chapter10/src/SkillBuilders/die2.jpeg",
						"../Chapter10/src/SkillBuilders/die3.jpeg",
						"../Chapter10/src/SkillBuilders/die4.jpeg",
						"../Chapter10/src/SkillBuilders/die5.jpeg",
						"../Chapter10/src/SkillBuilders/die6.jpeg"
				};

				dieFace1.setIcon(new ImageIcon(dieImages[newRoll - 1]));
				dieFace2.setIcon(new ImageIcon(dieImages[newRoll2 - 1])); 
			}
		});
