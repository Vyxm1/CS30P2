...
public class Account
{
	 ...
	 * Balance and customer data has been initialized with parameters.
	 */
	public Account(double bal, String fName, String lName, String st, String c, String p, String pCode)
	{
		balance = bal;
	...
	{
		balance = 0;
		cust = new Customer("", "", null, null, null, null);
		acctID = ID;
	}
